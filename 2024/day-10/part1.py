    ...
    for currentnumber in range(1,10):
        ...
        for position in newPositions:
            for direction in directions:
                    ...
                    if checkIfValidPosition(testposition) and testposition not in positionsFound:
        ...
        newPositions = list(dict.fromkeys(positionsFound))
    score+=len(list(dict.fromkeys(newPositions)))
